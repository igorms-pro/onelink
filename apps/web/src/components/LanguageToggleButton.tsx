...
export function LanguageToggleButton() {
  ...
  return (
    <div className="relative" ref={langDropdownRef}>
      ...
      {/* Language Dropdown */}
      {isLangOpen && (
        <div className="absolute right-0 top-full mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-[9999] min-w-[180px] max-h-[320px] overflow-y-auto pointer-events-auto">
          {languages.map((lang) => {
