...
export function Header({ onSettingsClick }: HeaderProps) {
  ...
  return (
    <header className="w-full flex items-center justify-between p-4 md:p-6 lg:p-8 border-b border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-gray-900 sticky top-0 z-50 shadow-sm">
      <div
