            ...
            {activeTab === "account" && (
              <div className="space-y-8">
                ...
                <section className="rounded-xl border border-gray-200/80 dark:border-gray-800/80 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 shadow-lg shadow-gray-200/50 dark:shadow-black/20 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                    Configure notifications, preferences, and more
                  </p>
                  <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 p-4 text-center">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Settings coming soon (notifications, email preferences,
                      etc.)
                    </p>
                  </div>
                </section>
